...
import { FaExternalLinkAlt, FaBuilding, FaSpinner } from "react-icons/fa";
...
const JobSearch = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-4xl mx-auto mt-20 bg-white rounded-lg shadow-lg p-10 text-gray-900"
    >
      ...
      {error && (
        <p className="mt-6 text-red-600 font-semibold text-center" role="alert">
          {error}
        </p>
      )}
            ...
            {jobs.map((job) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-gray-50 rounded-lg shadow-md p-6 hover:shadow-lg transition cursor-pointer"
                >
                  ...
                  <p className="text-gray-700 mb-2 text-sm leading-relaxed">
                    {isExpanded
                      ...
                      : (job.job_description || "No description available.").slice(0, 150) + "..."}
                  </p>
